            ...
            VStack {
                NavigationView {
                    List(filteredSearchTerms, id: \.id) { video in
                        NavigationLink(destination: StudentVideoView(video: video, userID: subscriptionVM.userID, subscriptionVM: StudentSubscriptionViewModel(userID: subscriptionVM.userID))) {
